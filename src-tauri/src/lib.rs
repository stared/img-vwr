    ...
    builder
        .export(
            specta_typescript::Typescript::default()
                ...
                // ts-nocheck: contract drift is caught at import sites and by the diff-clean check.
...
pub fn run() {
    ...
    app_builder
        // Each frame is addressed by a fresh token so the webview's image cache can never hand back the previous edit.
        ...
        .setup(move |app| {
            ...
            // User data (labels, edits, person names) lives in app data, deliberately never beside the photos.
